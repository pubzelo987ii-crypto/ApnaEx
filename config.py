...
# ------------------------------------------------
BOT_TOKEN = os.environ.get("BOT_TOKEN", "7732080124:AAF-qB0ROba9miDGPCCToN4rtWC9IQrv9Gc")
# ------------------------------------------------
BOT_USERNAME = os.environ.get("BOT_USERNAME", "@BotyIk32Bot")
BOT_TEXT = "MAX BHAI KA EXTRACTOR"
# ------------------------------------------------
